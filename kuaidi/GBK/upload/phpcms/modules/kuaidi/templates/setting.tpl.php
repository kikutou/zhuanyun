...
<table width="100%" class="table_form ">
	  ...
	  <tr>
        <th width="200"><?php echo L('content_tpl')?>£º<?php if ($nowsetting['template_list']) echo '<script type="text/javascript">$.getJSON(\'?m=admin&c=category&a=public_tpl_file_list&style='.$nowsetting['template_list'].'&id='.$nowsetting['show_template'].'&module=kuaidi&templates=show&name=setting&pc_hash=\'+pc_hash, function(data){$(\'#show_template\').html(data.show_template);});</script>'?></th>
