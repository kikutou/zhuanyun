var regexEnum = 
{
    ...
    letter_u:"^[A-Z]+$",					//大写字母
    letter_l:"^[a-z]+$",					//小写字母
    idcard:"^[1-9]([0-9]{13}|[0-9]{16})[1-9a-zA-Z]$",	//身份证
    ezine:"^\\d{4}(\.)\\d{2}\\1\\d{2}\\[第\\d{1,3}期\\]$",		//电子报
    ezinepage:"^\\d{4}(\\-)\\d{2}\\1\\d{2}.htm$"		//电子报文件
}
    ...
    $.formValidator = 
    {
        ...
        AjaxValid : function(returnObj)
        {
            ...
            if(setting.addidvalue)
            {
                ...
                var parm = id+"="+encodeURI(srcjo.val());
        ...
        return this.each(function()
        {
            ...
            if (srcTag == "INPUT" || srcTag=="TEXTAREA")
            {
                ...
                {   
                    ...
                    thefirstsettings[0].onkeyupevent(joeach.get(0));
                });
            } 
