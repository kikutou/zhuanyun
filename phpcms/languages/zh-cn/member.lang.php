...
$LANG['member_group_starnum'] = '直邮折扣';
$LANG['member_group_discount'] = '国内折扣';
$LANG['member_group_otherdiscount'] = '到港折扣';
$LANG['member_group_alldiscount'] = '全场折扣';
...
$LANG['points_less_than'] = '您的积分为<font color="red">{point}</font>，发布投稿需要扣除<font color="red">{need_point}</font>，您可以通过回复评论来获取积分';
$LANG['contributors_checked'] = '投稿成功，等待管理员审核';
$LANG['contributors_success'] = '内容已发布！感谢您的晒单！';
$LANG['has_been_verified'] = '投稿已经通过审核，不允许再次修改！';
$LANG['contribute_del_point'] = '投稿扣积分';
...
$LANG['cost'] = '支出';
$LANG['can_change_point_num'] = '可兑换金额';
$LANG['app_each'] = '应用间';
