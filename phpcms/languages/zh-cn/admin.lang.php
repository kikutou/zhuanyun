...
$LANG['main_shortcut'] = '订单统计信息';
$LANG['main_sysinfo'] = '系统信息';
$LANG['main_version'] = '系统版本：';
...
$LANG['main_product_name'] = '日本转运公司系统';
$LANG['main_product_team'] = '近日销量统计';
...
$LANG['setting_phpsso_type'] = '请填写接口地址，格式为：http://www.baidu.com,结尾不包含“/”';
...
$LANG['batch_truncate_table'] = '批量清空表数据';
...
$LANG['linkage_name'] = '地区名称';
$LANG['linkage_add'] = '添加地区';
$LANG['linkage_desc'] = '地区描述';
$LANG['linkage_calling_code'] = '调用代码';
$LANG['linkage_manage_submenu'] = '管理子地区';
$LANG['linkage_is_del'] = '是否删除地区?';
$LANG['linkage_add_submenu'] = '添加子地区';
...
$LANG['linkage_select'] = '=请选择地区';
$LANG['all_site'] = '所有站点';
$LANG['linkage_menu_style'] = '地区风格';
$LANG['linkage_parent_menu'] = '上级地区';
$LANG['site_select'] = '站点选择';
$LANG['linkage_not_empty'] = '不能为空';
$LANG['linkage_tips'] = '温馨提示：添加地区后，请点击地区后“更新缓存”按钮';
...
$LANG['site_billprefix'] = '系统单号前缀';
$LANG['package_overday'] = '包裹超期(天)';
$LANG['seo_configuration'] = 'SEO配置';
$LANG['introducer'] = '推荐人积分';
$LANG['regperson'] = '被推荐的人积分';
...
$LANG['site_att_watermark_img_desc'] = '水印存放路径:resource/images/water';
...
$LANG['modelid_edit_tips'] = ' <img src="./resource/images/icon/help.gif" title="当该栏目下数据为 0 时，可更换模型">';
...
$LANG['package_overdayfee'] = '包裹超期费用(日元/天)';
?>