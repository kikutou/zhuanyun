...
UserID  <input type="text" value="<?php echo $userid?>" class="input-text" name="info[userid]"> 
...
<input type="submit" value="<?php echo L('search')?>" class="button" name="dosubmit">
    ...
    <table width="100%" cellspacing="0">
        <thead>
			...
			<th width="10%">用户标识</th>
            <th width="10%"><?php echo L('order_sn')?></th>
            <th width="10%"><?php echo L('order_time')?></th>
            <th width="9%" style="display:none;"><?php echo L('business_mode')?></th>
            <th width="8%" style="display:none;"><?php echo L('payment_mode')?></th>
            <th width="8%"><?php echo L('deposit_amount')?></th>
			<th width="8%">会员余额</th>
            <th width="10%"><?php echo L('pay_status')?></th>
			
			<th width="10%"><?php echo L('operatorname')?></th>
			<th width="10%">备注</th>
...
?>   
	...
	<td  align="center"><?php echo $mrow['clientname']?></td>
	<td  align="center"><?php echo $info['trade_sn']?> <a href="javascript:void(0);" onclick="detail('<?php echo $info['id']?>', '<?php echo $info['trade_sn']?>')"><img src="<?php echo IMG_PATH?>admin_img/detail.png"></a></td>
	<td   align="center"><?php echo date('Y-m-d H:i:s',$info['addtime'])?></td>
	<td  align="center" style="display:none;"><?php echo L($info['pay_type'])?></td>
	<td  align="center" style="display:none;"><?php echo $info['payment']?></td>
	<td  align="center"><?php echo $info['money']?> <?php 
	if($info['type']==1) {
	if($info['money_type']==0){echo L('yuan') ;}else{echo '美元' ;}
	}else{echo  L('dian');}?></td>
<td  align="center"><?php echo $memberamount?></td>
	<td  align="center"><?php echo L($info['status'])?> </a></td>
	
	<td  align="center"><?php echo ($info['adminnote'])?> </a></td>
	<td  align="center"><?php echo ($info['usernote'])?> </a></td>
	<td  align="center">
