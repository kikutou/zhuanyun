...
<form name="myform" action="?m=member&c=member_setting&a=manage" method="post" id="myform">
	<table width="100%" class="table_form">
		...
		<tr>
			<td width="200">邮单号邮件内容</td> 
			<td>
				<textarea name="info[expressnoemail]" id="expressnoemail" style="width:80%;height:120px;"><?php echo $member_setting['expressnoemail']?></textarea>
				<BR>

			</td>
		</tr>
		<tr>
			<td width="200">运单号邮件内容</td> 
			<td>
				<textarea name="info[waybillemail]" id="waybillemail" style="width:80%;height:120px;"><?php echo $member_setting['waybillemail']?></textarea>
				<BR>
