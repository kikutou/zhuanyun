...
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td><input type="text" name="info[starnum]" class="input-text" id="group_starnum" size="6" value="0"></td>
		</tr>
		<tr>
			<td><?php echo L('member_group_discount')?></td> 
			<td><input type="text" name="info[discount]" class="input-text" id="group_discount" size="6" value="0"></td>
		</tr>
		<tr>
			<td><?php echo L('member_group_otherdiscount')?></td> 
			<td><input type="text" name="info[otherdiscount]" class="input-text" id="group_otherdiscount" size="6" value="0"></td>
		</tr>
		<tr>
			<td><?php echo L('member_group_alldiscount')?></td> 
			<td><input type="text" name="info[alldiscount]" class="input-text" id="group_alldiscount" size="6" value="0"></td>
		</tr>
	</table>
</fieldset>
<div class="bk15"></div>
