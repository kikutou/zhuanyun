...
class client {
	...
	public function ps_getavatar_upload_html($uid) {
		...
		$str = <<<EOF
				...
				<script language="javascript" type="text/javascript" src="{$this->ps_api_url}/resource/js/swfobject.js"></script>
				<script type="text/javascript">
					...
					swfobject.embedSWF("{$this->ps_api_url}/resource/images/main.swf", "phpsso_uploadavatar_flash", "490", "434", "9.0.0","{$this->ps_api_url}/resource/images/expressInstall.swf", flashvars, params, attributes);
