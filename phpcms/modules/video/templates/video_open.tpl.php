...
<a href="?m=video&c=video&a=complete_info&checkhash=<?php echo $_GET['checkhash'];?>"><?php echo L('complete_info_open');?> &gt;</a>
</div>
</div>
<div class="clear">
</div>
