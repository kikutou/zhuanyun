...
<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='?m=admin&c=database&a=public_truncate&pdo_name=<?php echo $pdo_name?>'" value="<?php echo L('batch_truncate_table')?>"/>
</div>
<?php 
}
?>
...
function show_tbl(obj) {
	var pdoname = $(obj).val();
	location.href='?m=admin&c=database&a=export&pdoname='+pdoname+'&checkhash=<?php echo $_SESSION['checkhash']?>';
}
