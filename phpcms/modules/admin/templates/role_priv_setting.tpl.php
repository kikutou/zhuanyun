...
<div style="padding:6px 3px">
    ...
    <div class="col-2 col-auto">
        ...
        <iframe name="role" id="role" src="?m=admin&c=role&a=role_priv&checkhash=<?php echo $_SESSION['checkhash']?>" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none" width="100%" height="483" allowtransparency="true"></iframe>
        </div>
    </div>
</div>
</body>
