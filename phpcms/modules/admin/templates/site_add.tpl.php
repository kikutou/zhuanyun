...
<fieldset>
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="billprefix" id="billprefix"  size="30"/></td>
  </tr>
  <tr>
    <th><?php echo L('package_overday')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="package_overday" id="package_overday"  size="30"/></td>
  </tr>
   <tr>
    <th><?php echo L('package_overdayfee')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="package_overdayfee" id="package_overdayfee"  size="30"/></td>
  </tr>
  <tr>
    <th><?php echo L('introducer')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="introducer" id="introducer"  size="30" value="5"/></td>
  </tr>
  <tr>
    <th><?php echo L('regperson')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="regperson" id="regperson"  size="30" value="5"/></td>
  </tr>
  <tr>
    <th>QQ：</th>
    <td class="y-bg"><input type="text" class="input-text" name="qqno" id="qqno"  size="30"/></td>
  </tr>
  <tr>
    <th>Tel：</th>
    <td class="y-bg"><input type="text" class="input-text" name="public_tel" id="public_tel"  size="30"/></td>
  </tr>

   <tr>
    <th><?php echo L('wbinfocustom');?>：</th>
    <td class="y-bg"><input type="radio" name="wbinfocustom"  value="0"/> Default &nbsp;&nbsp;<input type="radio" name="wbinfocustom"  value="1"/> Custom</td>
  </tr>
  
  <tr>
    <th>自动签收期限(天)：</th>
    <td class="y-bg"><input type="text" class="input-text" name="autofinsh" id="autofinsh"  size="30"/> 0表示不执行</td>
  </tr>
   <tr>
    <th>LOGO：</th>
    <td class="y-bg"><?php echo form::upfiles('logo','logo','','admin', '0',50,'', '','png|gif|jpg');?>	</td>
  </tr>
   <tr>
    <th>Footer：</th>
    <td class="y-bg"><textarea name="copyright" id="copyright" cols="60" rows=10></textarea></td>
  </tr>
</table>
</fieldset>
<div class="bk15"></div>
