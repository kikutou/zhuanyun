...
?>
<div class="pad-10">
<form method="post" action="?m=house&c=admin_house&a=add" name="myform" id="myform">
<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th width="80"><strong><?php echo L('house_title')?></strong></th>
		<td><input name="house[title]" id="title" class="input-text" type="text" size="20" ></td>
	</tr>
