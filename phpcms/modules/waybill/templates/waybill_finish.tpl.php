...
?>
<div class="pad-10">
<form method="post" action="?m=waybill&c=admin_waybill&a=waybill_finish&hid=<?php echo $_GET['hid'];?>" name="myform" id="myform">

<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th><strong><?php echo L('waybillid')?>：</strong></th>
		<td><textarea name="data[waybillid]" id="waybillid" class="input-text" type="text" cols="30" rows="11" ><?php echo $sno;?></textarea></td>
	</tr>
	<tr>
		<th><strong><?php echo L('finish_getgoodstime')?>：</strong></th>
