...
function show_content(url) {
	...
	$.get("?m=collection&c=node&a=public_test_content&nodeid=<?php echo $nodeid?>&url="+url+'&checkhash=<?php echo $_SESSION['checkhash']?>', function(data){art.dialog({id:'test'}).close();
