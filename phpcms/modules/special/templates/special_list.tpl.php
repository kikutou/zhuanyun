...
<p class="gray4"><?php echo L('create_man')?>：<a href="#" class="blue"><?php echo $info['username']?></a>， <?php echo L('create_time')?>：<?php echo format::date($info['createtime'], 1)?></p>
	...
	<td align="center"><span style="height:22"><a href='?m=special&c=content&a=init&specialid=<?php echo $info['id']?>' onclick="javascript:openwinx('?m=special&c=content&a=add&specialid=<?php echo $info['id']?>&checkhash=<?php echo $_SESSION['checkhash']?>','')"><?php echo L('add_news')?></a></span> | 
