...
?>
<div class="pad-10">
<form method="post" action="?m=coupon&c=admin_coupon&a=add" name="myform" id="myform">
<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th ><strong><?php echo L('coupon_title')?></strong></th>
		<td><input name="coupon[title]" id="title" class="input-text" type="text" size="40" ></td>
	</tr>
	<tr>
		<th><strong><?php echo L('remark')?>：</strong></th>
		<td><textarea name="coupon[remark]" id="remark" class="input-text"  cols="60" rows="5"></textarea></td>
	</tr>
	<tr>
		<th><strong><?php echo L('price')?>：</strong></th>
		<td><input name="coupon[price]" id="price" class="input-text" type="text" size="10" ></td>
	</tr>
	<tr>
		<th><strong><?php echo L('backpoints')?>：</strong></th>
		<td><input name="coupon[backpoints]" id="backpoints" class="input-text" type="text" size="10" ></td>
	</tr>
	<tr>
  		<th><strong><?php echo L('okdays')?>：</strong></th>
        <td>
		<input name="coupon[okdays]" id="okdays" class="input-text" type="text"  size="10" >
		</td>
	</tr>
	<tr>
  		<th><strong><?php echo L('minamount')?>：</strong></th>
        <td>
		<input name="coupon[minamount]" id="minamount" class="input-text" type="text"  size="10" >（为0表示不限）
		</td>
	</tr>
