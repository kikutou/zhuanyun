...
<input type="hidden" value="<?php echo $_SESSION['checkhash']?>" name="checkhash">
...
<div class="table-list comment">
	...
	?>
     <tr id="tbody_<?php echo $v['id']?>">
		...
		<td width="230"><a href="?m=comment&c=comment_admin&a=listinfo&search=1&searchtype=0&keyword=<?php echo urlencode($comment_info['title'])?>&checkhash=<?php echo $_SESSION['checkhash']?>&tableid=<?php echo $tableid?>"><?php echo $comment_info['title']?></td>
...
function show_tbl(obj) {
	var pdoname = $(obj).val();
	location.href='?m=comment&c=comment_admin&a=listinfo&tableid='+pdoname+'&checkhash=<?php echo $_SESSION['checkhash']?>';
}
