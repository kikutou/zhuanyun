...
?>
<div class="pad-10">
<form method="post" action="?m=enum&c=admin_enum&a=edititem&aid=<?php echo $_GET['aid']?>" name="myform" id="myform">
...
<tbody>
	...
	<tr>
		...
		$sel="";
		if($an_info['country']==trim($v['name'])){$sel=" selected";}
	...
	<tr>
		...
		<td><input name="enum[title]" id="title" value="<?php echo htmlspecialchars($an_info['title'])?>" class="input-text" type="text" size="20" ></td>
	</tr>
	<tr>
		<th width="80"><strong><?php echo L('value')?></strong></th>
		<td><input name="enum[value]" id="value" class="input-text" type="text" size="20" value="<?php echo $an_info['value'];?>"></td>
	</tr>
	...
	<tr>
		...
		if($_GET['gid']==48 || $_GET['gid']==152 || $_GET['gid']==123){
			...
			echo '<input name="enum[remark]" id="remark" class="input-text" type="text" size="20" value="'.$an_info['remark'].'">'.L('url_tip');
		}
	...
	<tr>
		...
		<td><input name="enum[listorder]" id="listorder" class="input-text" type="text" size="10" value="<?php echo $an_info['listorder'];?>"></td>
	</tr>
    </tbody>
</table>
<input name="enum[groupid]" id="groupid" type="hidden" value="<?php echo $an_info['groupid'];?>">
