...
<form action="index.php?m=attachment&c=address&a=update&checkhash=<?php echo $_SESSION['checkhash'];?>" method="post" onsubmit="return confirm('<?php echo L('form_submit_confirm');?>')">
