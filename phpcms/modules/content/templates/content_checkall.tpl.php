...
<tbody>
	...
	?>
		...
		<td align='left' ><a href="javascript:;" onclick='change_color(this);window.open("?m=content&c=content&a=public_preview&steps=<?php echo $r['status']?>&catid=<?php echo $r['catid'];?>&id=<?php echo $arr_checkid[1];?>&checkhash=<?php echo $_SESSION['checkhash'];?>","manage")'><?php echo $r['title'];?></a></td>
		...
		?></td>
		<td align='center' ><a href="javascript:;" onclick='change_color(this);window.open("?m=content&c=content&a=public_preview&steps=<?php echo $r['status']?>&catid=<?php echo $r['catid'];?>&id=<?php echo $arr_checkid[1];?>&checkhash=<?php echo $_SESSION['checkhash'];?>","manage")'><?php echo L('c_check');?></a></td>
	</tr>
     <?php }?>
</tbody>
     </table>
