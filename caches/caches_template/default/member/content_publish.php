...
<div id="memberArea" style="WIDTH: 1080px; height:880px; MARGIN: 0px auto">
		
		<div class="layout pro-mod" style="border-top:none;">  
			<?php include template('member', 'top'); ?>
		</div>
	<?php include template('member', 'left'); ?>
	<div class="col-auto" style="width:887px; margin-left:193px;">
		<div class="col-1 ">
			
			<div class="content" style="background:#fff; border:1px solid #cacaca;">
				
			<form method="post" action="" id="myform" name="myform">
				<table width="95%" cellspacing="0" class="table_form">
				...
				<?php } ?>
					...
					<tr>
						<th width="70"><?php if($v['star']) { ?> <font color="red">*</font><?php } ?> <?php echo $v['name'];?>：</th> 
					...
					<tr>
						...
						<input name="dosubmit" type="submit" id="dosubmit" value="<?php echo L('submit');?>" class="button" style="height:28px; width:45px; cursor:pointer;"></td>
					</tr>
				</table>
