...
<title><?php echo $this->__all__urls[0]['login'];?>--<?php echo $this->wap['sitename'];?></title>
...
color: #666666;
background:url(/resource/wap/images/7675119_090513353000_2.jpg) no-repeat #fff;
...
.footReturn h2{ margin:20px 0 20px 0; font-weight: normal; font-size:24px; text-align:center; color:#333}
.copyright{margin:15px 0 0px; text-align:center;font-size:12px;color:#666;display: block;}
...
.px::-moz-placeholder, textarea::-moz-placeholder { color: #999;}
.pxerror::-moz-placeholder { color: #ff6501;}
...
.px[readonly="readonly"] {
     background: #F9F9F9;color: #555555;
  border: 1px solid #C6C6C6;
  -webkit-box-shadow: none;
  -moz-box-shadow: none;
  box-shadow: none;
...
<div id="ui-header">
<div class="fixed">
<a class="ui-title" id="popmenu">会员登录</a>
	...
	<div class="cardexplain">
		<ul>
			<div class="footReturn" id="footReturn">
				...
				<div id="zxcz">
				<p>
				<input name="username" type="text" class="px" id="username" value="" placeholder="请输入用户名">
				</p>
				<p style=" margin:10px 0 0 0">
				<input name="password" type="password" class="px" id="parssword" value="" placeholder="请输入密码">
											<input name="url" id="url" type="hidden" value="">
				</p>
				<p style=" margin:10px 0"><a id="showcard" class="submit" href="javascript:void(0)">登 录</a></p>
				<p style=" margin:10px 0"><a class="copyright" href="#"><?php echo $this->wap['sitename'];?></a></p>
				</div>
			</div>
		</ul>
	</div>
...
var password =  document.getElementById('parssword').value;
...
$.post('/index.php?m=member&c=ajax_index&a=login&t='+Math.random(), submitData,
function(data) {
	if (data.status) {
